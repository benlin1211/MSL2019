...
#ifndef __AI_HAND_RECOG_H__
#define __AI_HAND_RECOG_H__
#pragma once

#include "ai_platform.h"

#define AI_HAND_RECOG_MODEL_NAME          "hand_recog"

#define AI_HAND_RECOG_IN_NUM       (1)
#define AI_HAND_RECOG_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 12, 32, 1, 1, NULL), \
}
#define AI_HAND_RECOG_IN_SIZE { \
  (12 * 32 * 1), \
}
#define AI_HAND_RECOG_IN_1_SIZE  (12 * 32 * 1)
#define AI_HAND_RECOG_IN_1_SIZE_BYTES  ((12 * 32 * 1) * 4)




#define AI_HAND_RECOG_OUT_NUM      (1)
#define AI_HAND_RECOG_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 10, 1, NULL), \
}
#define AI_HAND_RECOG_OUT_SIZE { \
  (1 * 1 * 10), \
}
#define AI_HAND_RECOG_OUT_1_SIZE  (1 * 1 * 10)
#define AI_HAND_RECOG_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)
 ...
 * @ref ai_hand_recog_create. Both the activations memory buffer 
 ...
 * using @ref ai_hand_recog_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_HAND_RECOG_*
 * defines into file @ref hand_recog.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_hand_recog_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_HAND_RECOG_H__*/
