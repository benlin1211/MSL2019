	...
	GPIO_init:
		...
		movs    r0, #0x3 //0000000(0011) :active A block
    	ldr     r1, =RCC_AHB2ENR
    	str     r0, [r1]
    	...
    	/*
    	movw    r0, #0x5555
    	lsl     r0, #2 // 000(0001)(0101 0101 0101 0100)
    	ldr     r1, =GPIOB_MODER
    	ldr     r2, [r1]
    	//mask: keep from modifying the origin setting
    	movs    r2, #0xFF
    	...
    	add     r2, r2, #0xFC
    	lsl     r2, #16
    	add     r2, r2, #0x3 // FFF(1100)(0000 0000 0000 0011)
    	orrs    r2, r2, r0
    	str     r2, [r1]

    	movw    r0, #0xAAAA
   		//(10):high speed
   		lsl     r0, #2 //000(0010)(1010 1010 1010 1000)
	...
	max7219_init:
		...
		ldr r1, =0xff //decode for all digit0~digit7
		BL max7219_send
